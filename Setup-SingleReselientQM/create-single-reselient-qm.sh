...
# Name of the namespace you want to create an MQ instance.
export NEW_NAMESPACE=z-mq
# Required Security contet constraints to create MQ
export SCC=ibm-anyuid-scc
# Provide a meaning fullname for your release
export RELEASE_NAME=single-reselient-qm1

export CHART_FOLDER_NAME=ibm-mqadvanced-server-integration-prod
