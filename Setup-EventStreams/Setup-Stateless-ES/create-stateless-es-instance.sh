...
# Name of the namespace you want to create an EventStreams instance.
export NEW_NAMESPACE=z-eventstreams
# Required Security contet constraints to create EventStreams
export SCC=ibm-restricted-scc
# Provide a meaning fullname for your release
export RELEASE_NAME=my-stateless-es

export CHART_FOLDER_NAME=ibm-eventstreams-icp4i-prod
