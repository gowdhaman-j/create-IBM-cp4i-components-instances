...
# Name of the namespace you want to create an Tracing instance.
export NEW_NAMESPACE=z-tracing
# Required Security contet constraints to create Tracing
export SCC=ibm-anyuid-scc
# Provide a meaning fullname for your release
export RELEASE_NAME=my-tracing

export CHART_FOLDER_NAME=ibm-icp4i-tracing-prod
