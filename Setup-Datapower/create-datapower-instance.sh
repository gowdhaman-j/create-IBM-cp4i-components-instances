...
# Name of the namespace you want to create an Datapower instance.
export NEW_NAMESPACE=z-datapower
# Required Security contet constraints to create DataPower
export SCC=ibm-anyuid-scc
# Provide a meaning fullname for your release
export RELEASE_NAME=my-datapower

export CHART_FOLDER_NAME=ibm-datapower-icp4i
