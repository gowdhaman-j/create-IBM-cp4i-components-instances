...
# Name of the namespace you want to create an APP Connect Designer instance.Avoid using OOB 'ace' namesapce.
export NEW_NAMESPACE=z-ace-designer
# Required Security contet constraints to create APP Connect Designer
export SCC=ibm-anyuid-scc
# Provide a meaning fullname for your release
export RELEASE_NAME=my-app-connect-designer

export CHART_FOLDER_NAME=ibm-app-connect-designer-icp4i
